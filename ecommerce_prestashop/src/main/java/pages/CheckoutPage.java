...
public class CheckoutPage {
	...
	private By botaoConfirmadoPedido = By.cssSelector("#payment-confirmation button");
	...
	public PedidoPage clicarBotaoConfirmadoPedido() {
		 driver.findElement(botaoConfirmadoPedido).click();
