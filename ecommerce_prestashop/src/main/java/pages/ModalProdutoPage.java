...
public class ModalProdutoPage {
	...
	private By listaDeValoresInformados = By.cssSelector("div.divide-right .col-md-6:nth-child(2) span strong");
	...
	public String obterCorProduto () {
		if ( driver.findElements(listaDeValoresInformados).size()== 3)
