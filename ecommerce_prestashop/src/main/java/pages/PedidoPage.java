...
public class PedidoPage {
	...
	private By totalProdutos = By.cssSelector("div.order-confirmation-table div.order-line.row div.bold");
	...
	public String obter_email() {
		//An email has been sent to the carlakdias@gmail.com address.
